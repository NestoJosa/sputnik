...
<!-- PrivacyPolicy -->
  <div class="container">
    <div class="Privacy row justify-content-center">
      <div class="col-md-8">
        ...
        <h2>Sikkerhed</h2>
        <p>Vi behandler dine personoplysninger sikkert og fortroligt i overensstemmelse med gældende lovgivning, herunder persondataforordningen og databeskyttelsesloven.<br>
        ...
        <ul>
          ...
          <li>Email: hello@autobahncph.dk</li>
        </ul>
