...
function load_css() 
{
  ...
  wp_register_style('_sputnik-styles', get_template_directory_uri() . 'dist/css/bundle.css', array(), '1', 'all' );
...
function load_js() 
{
  ...
  wp_enqueue_script( '_sputnik-scripts', get_template_directory_uri() . 'dist/js/bundle.js', array(), null, true );
